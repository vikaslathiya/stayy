...
import stayy_logo from "@/images/stayy-dark.png";
...
const Footer = () => {
    return (
        <footer className='flex pb-6  flex-col items-center gap-16 sm:gap-20'>
            <div className='flex px-6 pt-16 sm:pt-20 justify-between items-center w-86 flex-col sm:flex-row gap-6 border-t border-light-gray '>
                <div className='flex flex-col gap-6 items-start'>
                    <div className='flex flex-col gap-0 sm:gap-3 items-start'>
                        ...
                        <p className='text-dark-gray text-lg text-center'>Your private accommodations network.</p>
                    </div>
            ...
            <div className='flex py-3 justify-center items-center self-stretch'>
                <p className='text-medium-gray text-base sm:text-lg'>© 2023 STAYY LLC. All rights reserved.</p>
            </div>
        </footer>
    )
}
